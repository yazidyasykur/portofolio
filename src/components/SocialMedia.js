...
function SocialMedia (){
    return(
        <div className="flex flex-col gap-5  whitespace-nowrap items-center px-2 py-8 bg-slate-900 text-white">
            <h1 className="font-bold text-s  whitespace-nowrap">Social Media</h1>
